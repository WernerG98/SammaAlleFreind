export default function DatenschutzPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 text-sm text-gray-700 space-y-6">
      <h1 className="text-2xl font-bold text-teal-900 mb-2">Datenschutzerklärung</h1>
      ...
      <section>
        ...
        <p>
          ...
          <br />
          E-Mail:{" "}
          <a href="mailto:werner.glueck@gmx.net" className="text-teal-700 underline">
      ...
      <section>
        <h2 className="font-semibold text-gray-900 mb-1">2. Deine Rechte als betroffene Person</h2>
      ...
      <section>
        <h2 className="font-semibold text-gray-900 mb-1">3. Welche Daten wir erheben</h2>

        <h3 className="font-medium text-gray-900 mt-3 mb-1">Anmeldung zu einer Veranstaltung</h3>
        <p>
        ...
        <h3 className="font-medium text-gray-900 mt-3 mb-1">Interessenten- und Warteliste</h3>
        <p>
        ...
        <h3 className="font-medium text-gray-900 mt-3 mb-1">Newsletter</h3>
        <p>
        ...
        <h3 className="font-medium text-gray-900 mt-3 mb-1">Kontaktformular</h3>
        <p>
        ...
        <h3 className="font-medium text-gray-900 mt-3 mb-1">Zahlung</h3>
        <p>
        ...
        <h3 className="font-medium text-gray-900 mt-3 mb-1">Server-Logfiles</h3>
        <p>
      ...
      <section>
        <h2 className="font-semibold text-gray-900 mb-1">4. Cookies und lokale Speicherung</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold text-gray-900 mb-1">5. Eingesetzte Dienstleister</h2>
      ...
      <section>
        <h2 className="font-semibold text-gray-900 mb-1">6. Speicherdauer</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold text-gray-900 mb-1">7. Änderungen dieser Datenschutzerklärung</h2>
        <p>
